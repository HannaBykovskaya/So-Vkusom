...
export const ABOUT = {
  ...
  content:
    "Со Вкусом - это ресторан, созданный преданными поклонниками вкусной, разнообразной и полезной еды. Мы верим, что блюда, приготовленные с любовью могут дать силы на совершение самых важных подвигов! Мы продумали каждую деталь - от кулинарных шедевров нашего шеф-повара до внимательного обслуживания, поэтому каждый визит к нам будет самым настоящим событием. В нашем разнообразное меню, вдохновленном мировыми кухнями, каждое блюдо - это праздник вкуса и инноваций, а каждый кусочек оставляет неизгладимое впечатление. Присоединяйтесь к нам в кулинарном путешествии, где !",
};
